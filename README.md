...
2. `/register` → Регистрация
    - Минимальные правила валидации для пароля при регистрации. Необходимо минимум 4 цифры.
...
P.S. По причине отсутствия опыта в фронте, есть баги фронта при регистрации. Порой должным образом не происходит
редирект.
